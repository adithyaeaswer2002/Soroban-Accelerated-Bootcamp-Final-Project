...
// function fund_all() {
//   exe(`${soroban} keys generate ${process.env.SOROBAN_ACCOUNT} --rpc-url ${process.env.SOROBAN_RPC_URL} --network-passphrase ${process.env.SOROBAN_NETWORK_PASSPHRASE} --network ${process.env.SOROBAN_NETWORK}`);
